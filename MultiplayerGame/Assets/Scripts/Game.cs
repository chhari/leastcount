...
namespace GoFish
{
    public class Game : MonoBehaviour
    {
        ...
        void OnGameStarted()
        {
            ...
            gameDataManager.DealCardValuesToPlayer(localPlayer.PlayerId, Constants.PLAYER_INITIAL_CARDS);
            gameDataManager.DealCardValuesToPlayer(remotePlayer.PlayerId, Constants.PLAYER_INITIAL_CARDS);
